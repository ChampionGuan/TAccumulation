...
namespace X3Battle
{
    ...
    [Name("法术场作用开始\nMagicFieldBegin")]
    public class FEMagicFieldBegin : FlowEvent
    {
        ...
        {
            Battle.Instance.eventMgr.AddListener<EventMagicFieldState>(EventType.MagicFieldStateChange, _actionOnMagicField, "FEMagicFieldBegin._OnMagicField");
        }
        ...
        private void _OnMagicField(EventMagicFieldState eventAttrChange)
        {
            ...
            if (eventAttrChange.state != MagicFieldStateType.Begin)
                return;
