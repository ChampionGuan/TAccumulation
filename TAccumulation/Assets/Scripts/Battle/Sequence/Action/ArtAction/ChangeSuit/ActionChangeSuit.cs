...
namespace X3Battle
{
    public class ActionChangeSuit : BSAction
    {
        ...
        protected override void _OnInit()
        {
            ...
            var track = GetTrackAsset<ChangeSuitTrack>();
            var clipAsset = GetClipAsset<ChangeSuitClip>();

            _useOriginal = clipAsset.useOriginal;
            _targetSuitID = clipAsset.targetSuitID;
            _bindSuitID = track.extData.bindSuitID;
            // 运行时扩容一下HashSet
        ...
        protected override void _OnEnter()
        {
            base._OnEnter();
            _Clear();
            _bindObject = GetTrackBindObj<GameObject>();
