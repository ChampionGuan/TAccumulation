...
{
    // 物理风场behaviour
    public class PhysicsWindBehaviour : InterruptBehaviour
    {
        ...
        {
            using (ProfilerDefine.PhysicsWindOnStartMarker.Auto())
            {
        ...
        {
            using (ProfilerDefine.PhysicsWindOnStopMarker.Auto())
            {
