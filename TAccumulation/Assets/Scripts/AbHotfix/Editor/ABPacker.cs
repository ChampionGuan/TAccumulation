...
namespace LCG
{
    public class ABPacker : EditorWindow
    {
        ...
        {
            if (fileName.EndsWith(".fontsettings") || fileName.EndsWith(".anim") || fileName.EndsWith(".renderTexture") || fileName.EndsWith(".flare") || fileName.EndsWith(".shader") || fileName.EndsWith(".mask") || fileName.EndsWith(".playable") || fileName.EndsWith(".controller") || fileName.EndsWith(".mixer") || fileName.EndsWith(".prefab") || fileName.EndsWith(".mp3") || fileName.EndsWith(".shader") || fileName.EndsWith(".ttf")
