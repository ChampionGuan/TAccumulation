...
namespace LCG
{
    public class ABHttpImage : MonoBehaviour
    {
        private static ABHttpImage _instance;
        public static ABHttpImage Instance
        {
            get
            {
                if (null == _instance)
                {
                    GameObject target = new GameObject("httpImage");
                    _instance = target.AddComponent<ABHttpImage>();
                }
                return _instance;
            }
        }
