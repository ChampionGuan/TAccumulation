...
namespace BookCurlPro
{
    ...
    public class BookPro : MonoBehaviour
    {
        ...
        public X3Image ClippingPlane;
        public X3Image Shadow;
        public X3Image LeftPageShadow;
        public X3Image RightPageShadow;
        public X3Image ShadowLTR;
        ...
        public void DragRightPageToPoint(Vector3 point)
        {
            ...
            Left = papers[currentPaper - 1].Front.GetComponent<X3Image>();
            ...
            Right = papers[currentPaper - 1].Back.GetComponent<X3Image>();
