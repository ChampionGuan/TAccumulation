...
public class BezierCurve3DEditor : UnityEditor.Editor
{
    ...
    protected virtual void OnEnable()
    {
        ...
        this.keyPoints = new ReorderableList(this.serializedObject, serializedObject.FindProperty("keyPoints"), true,
            true, false, false);
    ...
    {
        BezierPoint3D newPoint = new GameObject("Point " + curve.KeyPointsCount, typeof(BezierPoint3D))
