...
namespace LCG
{
    public class LCGEditorWindow : BaseEditorWindow<LCGEditorWindow>
    {
        ...
        static void Build()
        {
            ...
            // BuildPipeline.BuildAssetBundles("",BuildAssetBundleOptions.None|BuildAssetBundleOptions.IgnoreTypeTreeChanges,BuildTarget.Android);
        }
