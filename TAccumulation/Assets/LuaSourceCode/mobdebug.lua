...
local print = function(...) if not is_print_enable then return end Debug.Log(...) end
...
mobdebug.cur_dir = getCurrentDir -- callback
mobdebug.basedir = function(b) if b then basedir = b end return basedir end
mobdebug.connect_ip = function() return (lasthost or "nil")..":"..(lastport or "nil") end
